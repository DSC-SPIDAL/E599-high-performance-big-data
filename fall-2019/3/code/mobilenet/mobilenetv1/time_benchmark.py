...
image_paths = glob.glob( "/N/u/mloukil/mobilenetv1/data_prepare/test_images/*.jpg")
print(image_paths)
total_time = 0
capture_time = 0
preproc_time = 0
...
print('total capture time (s): ' + str(capture_time) + '\n')
...
print('total capture time (s): ' + str(capture_time/image_count) + '\n')
...
print('average FPS: ' + str(1/(total_time / image_count)) + '\n')  
